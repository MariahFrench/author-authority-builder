...
async function checkCredentialsFileSafety(path, onWarn = (m) => console.warn(`anthropic-sdk: ${m}`)) {
	...
	const fs = await import("./browser-external_node_fs-CricAmDg.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	let resolved = path;
	let st;
	try {
...
async function writeCredentialsFileAtomic(targetPath, data) {
	const fs = await import("./browser-external_node_fs-CricAmDg.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const dir = (await import("./browser-external_node_path-jhuYRk69.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).dirname(targetPath);
...
var loadConfigWithSource = async (profile) => {
	...
	const fs = await import("./browser-external_node_fs-CricAmDg.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const configPath = (await import("./browser-external_node_path-jhuYRk69.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).join(rootConfigPath, "configs", `${profileName}.json`);
	let configRaw;
	try {
...
var getCredentialsPath = async (config, profile) => {
	...
	validateProfileName(profileName);
	return (await import("./browser-external_node_path-jhuYRk69.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).join(rootConfigPath, "credentials", `${profileName}.json`);
};
var getRootConfigPath = async () => {
	if (!supportsLocalConfigFiles()) return null;
	const path = await import("./browser-external_node_path-jhuYRk69.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
var getActiveProfileName = async () => {
	...
	const fs = await import("./browser-external_node_fs-CricAmDg.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const filePath = (await import("./browser-external_node_path-jhuYRk69.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).join(rootConfigPath, "active_config");
	try {
		...
		try {
			resp = await config.fetch(url, {
				...
				headers: {
					...
					"User-Agent": config.userAgent || `anthropic-sdk-typescript/0.98.0 oidcFederationProvider`
				},
				body: JSON.stringify(body)
			});
		} catch (err) {
		...
		try {
			resp = await config.fetch(url, {
				...
				headers: {
					...
					"User-Agent": config.userAgent || `anthropic-sdk-typescript/0.98.0 userOAuthProvider`
				},
				body: JSON.stringify(body)
			});
		} catch (err) {
...
_SessionToolRunner_requestOptions = function _SessionToolRunner_requestOptions() {
	...
	if (lastWasEndTurn && unanswered.length === 0) __classPrivateFieldGet(this, _SessionToolRunner_instances, "m", _SessionToolRunner_armIdleTimer).call(this);
	else __classPrivateFieldGet(this, _SessionToolRunner_instances, "m", _SessionToolRunner_disarmIdleTimer).call(this);
	for (const ev of unanswered) await __classPrivateFieldGet(this, _SessionToolRunner_instances, "m", _SessionToolRunner_execute).call(this, ev);
	...
	if (isEndTurnIdle(ev)) __classPrivateFieldGet(this, _SessionToolRunner_instances, "m", _SessionToolRunner_armIdleTimer).call(this);
	else __classPrivateFieldGet(this, _SessionToolRunner_instances, "m", _SessionToolRunner_disarmIdleTimer).call(this);
	switch (ev.type) {
		case "agent.tool_use":
...
}, _SessionToolRunner_execute = async function _SessionToolRunner_execute(ev) {
	var _a, _b;
...
_EnvironmentWorker_signal = /* @__PURE__ */ new WeakMap(), _EnvironmentWorker_instances = /* @__PURE__ */ new WeakSet(), _EnvironmentWorker_handleItem = async function _EnvironmentWorker_handleItem(work, environmentKey, externalSignal) {
	...
	const agentToolset = await import("./node-Dd-jZyrK.js");
...
Anthropic.Beta = Beta;
//#endregion
export { UnprocessableEntityError as C, RateLimitError as S, __classPrivateFieldSet as T, BadRequestError as _, promiseWithResolvers as a, NotFoundError as b, PagePromise as c, APIConnectionError as d, APIConnectionTimeoutError as f, AuthenticationError as g, AnthropicError as h, HUMAN_PROMPT as i, APIPromise as l, APIUserAbortError as m, Anthropic as n, ToolError as o, APIError as p, BaseAnthropic as r, toFile as s, AI_PROMPT as t, loggerFor as u, ConflictError as v, __classPrivateFieldGet as w, PermissionDeniedError as x, InternalServerError as y };

//# sourceMappingURL=sdk-BzmOgV_-.js.map